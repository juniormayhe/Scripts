...
display_message "🔍 Checking connectivity to namespace 'kubernetes-dashboard'... "
if ! kubectl get namespace kubernetes-dashboard &>/dev/null; then
    ...
    display_message "Removing Kubernetes Dashboard 🎛️" "nonewline"
...
display_message "🧹 Deleting Kubernetes Dashboard Namespace... "
